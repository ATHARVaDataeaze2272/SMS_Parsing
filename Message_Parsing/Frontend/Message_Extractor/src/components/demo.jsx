...
//                           <tr key={index}>
//                             <td className="px-6 py-4 text-sm text-gray-500 max-w-md break-words">{msg.message}</td> {/* Wrap message */}
//                             {getTableHeaders().map(field => (
//                               <td key={field} className="px-6 py-4 text-sm text-gray-500">
//                                 {msg.extracted_data[field] != null ? String(msg.extracted_data[field]) : 'N/A'}
//                               </td>
//                             ))}
//                           </tr>
//                         ))}
